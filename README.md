# BOJ Douala - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **BOJ Douala**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@bojdouala.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@bojdouala.cm` | `user123` | |
